<template>
  <div>
    ...
    <section id="servicios" class="section-secondary center">
      <div class="container">
            ...
            <div class="frame hoverable z-depth-1">
              <svg fill="#000000" width="92" height="92" version="1.1" id="lni_lni-map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 64 64" style="enable-background:new 0 0 64 64;" xml:space="preserve">
                <g>
                  ...
                  <path d="M58.2,17.9L41.3,14c0.1-0.4,0.1-0.7,0.1-1c0-4.9-3.8-8.8-8.7-8.8C27.9,4.2,24,8.1,24,13c0,1.2,0.5,2.8,1.2,4.5l-2.8,0.6L8.7,14.2c-1.8-0.5-3.7-0.2-5.2,1c-1.5,1.1-2.3,2.8-2.3,4.7v29.6c0,2.6,1.8,5,4.3,5.7l16.8,4.7l19.4-4L55.5,59c0.4,0.1,0.9,0.2,1.3,0.2c1.3,0,2.6-0.4,3.7-1.3c1.4-1.1,2.2-2.8,2.2-4.6V23.6C62.8,20.8,60.9,18.5,58.2,17.9z M32.8,7.7c2.9,0,5.2,2.3,5.2,5.3c0,1.6-2,5.7-5.2,10.6c-3.2-4.8-5.2-8.9-5.2-10.6C27.5,10.1,29.9,7.7,32.8,7.7z M26.9,20.7c1.2,2.1,2.5,4.2,3.8,6.1c0.5,0.7,1.2,1.1,2,1.1c0,0,0,0,0,0c0.8,0,1.6-0.4,2-1.1c1.8-2.7,3.9-5.9,5.2-8.8v34.7l-15.8,3.3V21.3L26.9,20.7z M4.8,49.4V19.9c0-0.8,0.3-1.5,0.9-1.9c0.6-0.5,1.4-0.6,2.1-0.4l12.8,3.6v34.6l-14.1-4C5.5,51.5,4.8,50.5,4.8,49.4zM59.3,53.3c0,0.7-0.3,1.4-0.9,1.9c-0.6,0.5-1.3,0.6-2,0.5l-12.9-3V18l13.9,3.2c1.1,0.3,1.9,1.2,1.9,2.3V53.3z"/>
                </g>
              </svg>
    ...
    <div class="divider"></div>
    <section id="contactenos" class="section-primary center">
      <div class="container">
        ...
        <div class="row">
          <div class="col s12">
            ...
            <form>
              ...
              <a class="waves-effect waves-light btn green darken-2">Enviar</a>
            </form>
          </div>
        </div>
      </div>
